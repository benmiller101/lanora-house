        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              We're based right here in Hayle, so we know the area well and can offer fast response times, flexible bookings, and a truly local touch. <a href="tel:+447843930927" className="text-primary hover:underline">Contact our local team</a> for immediate service.
            </p>
