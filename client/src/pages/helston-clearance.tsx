...
const HelstonClearancePage = () => {
  ...
  const handleQuoteSubmit = (e: React.FormEvent) => {
    ...
    // Add service type
    formData.append('serviceType', 'helston-clearance');
    formData.append('location', 'Helston');
  ...
  const services = [
    ...
    },
    {
      ...
      title: "Loft, Attic, Basement & Garage Clearouts",
    ...
    },
    {
      ...
      title: "Garden Waste & Shed Dismantling",
      description: "Outdoor clearances and shed removal",
    ...
    },
    {
      ...
      title: "Office, Commercial & Retail Clearance",
    ...
    },
    {
      ...
      description: "Flexible collection and removal services",
  ...
  const whyChooseUs = [
    {
      ...
      title: "Locally Based",
      description: "Fast service across West Cornwall"
    },
    {
    ...
    },
    {
      ...
      title: "Own Vehicles & Team",
      description: "No subcontractors"
    },
    {
      icon: <Users className="w-6 h-6 text-purple-600" />,
      title: "Friendly & Respectful",
      description: "Discreet especially for sensitive jobs"
    },
    {
  ...
  const clientTypes = [
    ...
    },
    {
      ...
      title: "Support Workers & Social Services",
      description: "Professional support"
    }
  ];

  const nearbyAreas = [
    "Porthleven", "Mullion", "Gweek", "Breage", "St Keverne", "The Lizard Peninsula"
  ];

  const faqs = [
    {
      question: "Can you handle probate clearances in Helston?",
      answer: "Yes — we regularly work with families and solicitors to sensitively manage estate clearances."
    },
    {
      question: "What if the house is hoarded or in poor condition?",
      answer: "No problem — our team is experienced, non-judgmental, and fully equipped for heavy or complex clearances."
    },
    {
      question: "Do you remove large and heavy items like fridges or wardrobes?",
      answer: "Absolutely — we handle everything from white goods to awkward furniture."
    },
    {
      question: "What happens to the items removed?",
      answer: "We recycle, donate, and resell where possible. Anything unusable is disposed of legally and safely."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-blue-50">
      <Helmet>
        <title>House Clearance Helston West Cornwall - Professional Property Clearance | Lanora House</title>
        <meta name="description" content="Lanora House delivers fast, professional house clearance in Helston and surrounding areas. Cornwall's trusted clearance specialists with eco-conscious approach." />
        <meta name="keywords" content="house clearance Helston, property clearance Helston Cornwall, probate clearance Helston, office clearance Helston, waste removal Helston" />
        <meta property="og:title" content="House Clearance Helston West Cornwall | Lanora House" />
        <meta property="og:description" content="Professional clearance services in Helston. Local Cornwall-based team with fast response times and eco-conscious approach." />
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-primary bg-clip-text text-transparent">
              ...
              <span className="text-3xl md:text-5xl flex items-center justify-center gap-3 flex-wrap">
                ...
                <span className="text-2xl md:text-3xl text-gray-600 font-normal">Helston</span>
              </span>
            </h1>
            <p className="text-xl text-gray-600 mb-4 max-w-3xl mx-auto">
              Whether you're moving house, handling a probate estate, dealing with a hoarded property, or simply ready to declutter — Lanora House offers fast, professional house clearance in Helston and the surrounding areas.
            </p>
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              We're Cornwall-based, fully licensed, and committed to responsible waste disposal with a zero-to-landfill promise. <a href="tel:+447843930927" className="text-primary hover:underline">Speak to our team</a> about your requirements.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Dialog open={isQuoteDialogOpen} onOpenChange={setIsQuoteDialogOpen}>
                ...
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                  <DialogHeader>
                    <DialogTitle className="text-2xl text-primary">Get Your Free Helston Clearance Quote</DialogTitle>
                  </DialogHeader>
                  <form onSubmit={handleQuoteSubmit} className="space-y-6">
                      ...
                      <div>
                        ...
                        <Select value={quoteForm.propertyType} onValueChange={(value) => handleInputChange("propertyType", value)}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="hoarded-property">Hoarded Property</SelectItem>
                    ...
                    <div>
                      <Label htmlFor="address">Property Address in Helston *</Label>
                      <Input
                        id="address"
                        required
                        value={quoteForm.address}
                        onChange={(e) => handleInputChange("address", e.target.value)}
                        placeholder="Enter full address in Helston area"
                      />
                    </div>
                      ...
                      <div>
                        ...
                        <Select value={quoteForm.clearanceType} onValueChange={(value) => handleInputChange("clearanceType", value)}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="loft-attic-basement">Loft, Attic, Basement & Garage</SelectItem>
                            <SelectItem value="garden-waste-shed">Garden Waste & Shed Dismantling</SelectItem>
                            ...
                            <SelectItem value="office-commercial">Office, Commercial & Retail Clearance</SelectItem>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Any parking restrictions, narrow access, stairs, or other access issues in Helston we should know about?"
                        rows={3}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Any sensitive situations, probate clearances, hoarding support, heavy items, or need for discretion?"
                        rows={3}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Tell us more about your clearance requirements in Helston"
                        rows={4}
                      />
                    </div>
      ...
      {/* Helston Location Showcase Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <Badge className="mb-4 bg-primary/20 text-primary border-primary/30">
                <Music className="w-4 h-4 mr-1" />
                Proudly Serving Helston
              </Badge>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">
                West Cornwall's
                <br />
                <span className="text-2xl md:text-3xl text-gray-700">Flora Day Festival Town</span>
              </h2>
              <div className="space-y-4 text-gray-600">
                <p className="text-lg leading-relaxed">
                  <strong className="text-primary">Cornwall-based specialists</strong> serving Helston and West Cornwall. We understand this traditional town and its unique clearance needs.
                </p>
                <p className="leading-relaxed">
                  From the town center to The Lizard Peninsula, from traditional properties to modern developments, we provide trusted clearance services throughout Helston and the surrounding area.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                  <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">West Cornwall coverage</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Eco-first approach</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="bg-blue-50 rounded-2xl p-6 shadow-lg">
                <div className="text-center mb-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Find Us in Helston</h3>
                  <p className="text-gray-600">Flora Day Festival Town, West Cornwall</p>
                </div>
                
                {/* Embedded Google Maps */}
                <div className="relative rounded-xl overflow-hidden shadow-md bg-gray-200 h-80">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d10187.477524778273!2d-5.2700!3d50.1031!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x486ab2e5e5e5e5e5%3A0x404c6d0fb97d9b!2sHelston%2C%20UK!5e0!3m2!1sen!2suk!4v1620000000000!5m2!1sen!2suk"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
                ...
                <div className="mt-6 p-4 bg-white rounded-xl shadow-sm border">
                  ...
                  <div className="text-sm text-gray-600 space-y-2">
                    <div>🌸 <strong>Flora Day Festival:</strong> Famous tradition where locals dance through the streets to celebrate spring</div>
                    <div>🎭 <strong>Ancient Tradition:</strong> One of Cornwall's oldest and most unique traditions</div>
                    <div>📍 <strong>Gateway to Lizard:</strong> Perfect location for accessing The Lizard Peninsula</div>
                    <div>🏘️ <strong>Market Town:</strong> Traditional Cornish market town with modern community spirit</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-blue-100 text-blue-800 border-blue-300">
              ...
              What We Clear in Helston
            </Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Complete Clearance Services
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              No job too big, no space too cluttered — we clear with care, not chaos.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-green-50">
        <div className="max-w-4xl mx-auto text-center">
          <Badge className="mb-4 bg-green-100 text-green-800 border-green-300">
            ...
            Responsible Waste Disposal in Helston
          </Badge>
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">
            Eco-First Approach in Helston
          </h2>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            At Lanora House, we don't just clear — we manage waste ethically. We aim to keep your clearance cost-effective and environmentally conscious.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-bold text-lg mb-2">Recycling & Reuse</h3>
              <p className="text-gray-600 text-sm">All suitable items</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
              ...
              <p className="text-gray-600 text-sm">Local charities where possible</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
                <Star className="w-8 h-8 text-yellow-600" />
              </div>
              <h3 className="font-bold text-lg mb-2">Resale</h3>
              <p className="text-gray-600 text-sm">Valuable goods through auction</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
                <Trash2 className="w-8 h-8 text-purple-600" />
              </div>
              <h3 className="font-bold text-lg mb-2">Proper Handling</h3>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Waste documentation</p>
            </div>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Why Choose Lanora House in Helston?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We're here to make your clearance smooth, simple, and stress-free.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Who We Work With in Helston
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We're flexible, reliable, and always respectful of your space and your situation.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Book Your House Clearance in Helston
            </h2>
            <p className="text-xl mb-8 opacity-90">
              Start your clearance the easy way — get in touch with Lanora House for a free, no-obligation quote today.
            </p>
            ...
            <div className="mt-12 p-6 bg-white/10 rounded-lg backdrop-blur-sm">
              <h3 className="text-2xl font-bold mb-4">Helston's Trusted Clearance Team – Book with Lanora House</h3>
              <p className="text-lg opacity-90">
                We make clearance easy, ethical, and affordable – right here in Helston.
              </p>
            </div>
          </motion.div>
        </div>
...
export default HelstonClearancePage;