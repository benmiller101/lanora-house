...
const TruroClearancePage = () => {
  ...
  const handleQuoteSubmit = (e: React.FormEvent) => {
    ...
    // Add service type
    formData.append('serviceType', 'truro-clearance');
    formData.append('location', 'Truro');
  ...
  const services = [
    {
      ...
      description: "Complete property clearances for any situation",
      highlight: "Comprehensive service"
    },
    {
      icon: <TreePine className="w-8 h-8 text-green-600" />,
      title: "Garden Waste & Shed Removal",
      description: "Outdoor clearances and garden waste removal",
    ...
    },
    {
      ...
      title: "Office & Commercial Premises",
      description: "Business clearances and commercial refits",
      highlight: "Business solutions"
    },
    {
      icon: <Home className="w-8 h-8 text-indigo-600" />,
      title: "Lofts, Basements, Garages",
      description: "Specialized space clearances",
    ...
    },
    {
      ...
      title: "Hoarder Clearance & Deep Clean",
      description: "Sensitive support for severe clutter situations",
      highlight: "No judgment approach"
    },
    {
      icon: <Trash2 className="w-8 h-8 text-gray-600" />,
      title: "Wait and Load Waste Removal",
      description: "Flexible waste collection services",
  ...
  const whyChooseUs = [
    {
      ...
      title: "Local Team",
      description: "Based in Cornwall, serving Truro with pride"
    },
    {
      icon: <Zap className="w-6 h-6 text-blue-600" />,
      title: "Fast Quotes",
      description: "No-obligation quotes with flexible scheduling"
    },
    {
      icon: <Shield className="w-6 h-6 text-green-600" />,
      title: "Fully Licensed & Insured",
      description: "Registered waste carrier with full compliance"
    },
    {
      icon: <Users className="w-6 h-6 text-purple-600" />,
      title: "Own Trucks, Own Team",
      description: "No subcontractors or third-party strangers"
    },
    {
      icon: <Leaf className="w-6 h-6 text-green-700" />,
      title: "Eco-First Approach",
      description: "Ethical, sustainable clearance that makes a difference"
    }
  ];

  const nearbyAreas = [
    "St Austell", "Newquay", "Falmouth", "Penryn", "Redruth", "Mid Cornwall villages"
  ];

  const faqs = [
    {
      question: "Can you remove everything, even bulky or difficult items?",
      answer: "Yes – including white goods, wardrobes, beds, pianos, and more."
    },
    {
      question: "Do you clear houses affected by hoarding?",
      answer: "We do – with care, respect, and no judgment. Our team is experienced in difficult clearances."
    },
    {
      question: "How much does it cost?",
      answer: "Every job is different. We provide free quotes with no hidden fees."
    },
    {
      question: "Are you licensed to dispose of waste in Truro?",
      answer: "Yes – we're a registered waste carrier with full insurance and the correct licensing."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-blue-50">
      <Helmet>
        <title>Professional House Clearance Truro Cornwall - Fast, Ethical & Local | Lanora House</title>
        <meta name="description" content="Lanora House provides professional house and property clearance in Truro and surrounding area. Fast, ethical, local. Full house clearances, probate, commercial premises." />
        <meta name="keywords" content="house clearance Truro, property clearance Truro Cornwall, probate clearance Truro, office clearance Truro, waste removal Truro" />
        <meta property="og:title" content="Professional House Clearance Truro Cornwall | Lanora House" />
        <meta property="og:description" content="Lanora House provides professional house clearance in Truro. Fast, ethical, local service with zero-to-landfill policy." />
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Dialog open={isQuoteDialogOpen} onOpenChange={setIsQuoteDialogOpen}>
                ...
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                  <DialogHeader>
                    <DialogTitle className="text-2xl text-primary">Get Your Free Truro Clearance Quote</DialogTitle>
                  </DialogHeader>
                  <form onSubmit={handleQuoteSubmit} className="space-y-6">
                      ...
                      <div>
                        ...
                        <Select value={quoteForm.propertyType} onValueChange={(value) => handleInputChange("propertyType", value)}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="student-house">Student House</SelectItem>
                    ...
                    <div>
                      <Label htmlFor="address">Property Address in Truro *</Label>
                      <Input
                        id="address"
                        required
                        value={quoteForm.address}
                        onChange={(e) => handleInputChange("address", e.target.value)}
                        placeholder="Enter full address in Truro"
                      />
                    </div>
                      ...
                      <div>
                        ...
                        <Select value={quoteForm.clearanceType} onValueChange={(value) => handleInputChange("clearanceType", value)}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="office-commercial">Office & Commercial Premises</SelectItem>
                            <SelectItem value="loft-basement">Lofts, Basements, Garages</SelectItem>
                            <SelectItem value="electronic-weee">Electronic Waste (WEEE)</SelectItem>
                            <SelectItem value="hoarder-clearance">Hoarder Clearance & Deep Clean</SelectItem>
                            <SelectItem value="wait-load">Wait and Load Waste Removal</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Any parking restrictions, narrow access, stairs, or other access issues in Truro we should know about?"
                        rows={3}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Any bulky items, hazardous materials, or other specific requirements?"
                        rows={3}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Tell us more about your clearance requirements in Truro"
                        rows={4}
                      />
                    </div>
      ...
      {/* Truro Location Showcase Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <Badge className="mb-4 bg-primary/20 text-primary border-primary/30">
                <MapPin className="w-4 h-4 mr-1" />
                Proudly Serving Truro
              </Badge>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">
                Your Cornwall City 
                <br />
                <span className="text-2xl md:text-3xl text-gray-700">Clearance Experts</span>
              </h2>
              <div className="space-y-4 text-gray-600">
                <p className="text-lg leading-relaxed">
                  <strong className="text-primary">Cornwall-based specialists</strong> serving Truro and the surrounding area. We understand the unique challenges of clearing properties in Cornwall's only city.
                </p>
                <p className="leading-relaxed">
                  From the historic city center to the residential areas, from student houses near Truro College to commercial premises in the business district, we've been helping Truro residents and businesses with professional clearances for years.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                  <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Quick quotes & service</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Registered waste carrier</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="bg-blue-50 rounded-2xl p-6 shadow-lg">
                <div className="text-center mb-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Find Us in Truro</h3>
                  <p className="text-gray-600">Cornwall's Only City</p>
                </div>
                
                {/* Embedded Google Maps */}
                <div className="relative rounded-xl overflow-hidden shadow-md bg-gray-200 h-80">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d10147.477524778273!2d-5.0477!3d50.2632!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x486ab8e5e5e5e5e5%3A0x404c6d0fb97d9b!2sTruro%2C%20UK!5e0!3m2!1sen!2suk!4v1620000000000!5m2!1sen!2suk"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
                ...
                <div className="mt-6 p-4 bg-white rounded-xl shadow-sm border">
                  ...
                  <div className="text-sm text-gray-600 space-y-2">
                    <div>🏛️ <strong>Only City in Cornwall:</strong> Truro is Cornwall's administrative center and only city</div>
                    <div>⛪ <strong>Three Spires Cathedral:</strong> Beautiful cathedral with rare three-spire architecture</div>
                    <div>🌊 <strong>Three Rivers:</strong> Name comes from Cornish "Tri-veru" meaning "three rivers"</div>
                    <div>🎓 <strong>Education Hub:</strong> Home to Truro College and University of Exeter Cornwall campus</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-blue-100 text-blue-800 border-blue-300">
              ...
              What We Clear in Truro
            </Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Complete Clearance Services
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We also provide specialist clearance services for retail units, vape shops, offices, and industrial units. Plus hazardous waste and dead animal removal.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-green-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">
            Clearance You Can Trust in Truro
          </h2>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            At Lanora House, we're committed to doing things responsibly. We care about where your waste ends up — and we make sure nothing useful goes to waste.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-bold text-lg mb-2">Zero-to-Landfill</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-lg mb-2">Items Reused</h3>
              <p className="text-gray-600 text-sm">Or donated</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-lg mb-2">All Waste</h3>
              <p className="text-gray-600 text-sm">Recycled & reported</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
                <CheckCircle className="w-8 h-8 text-green-700" />
              </div>
              <h3 className="font-bold text-lg mb-2">Legal & Ethical</h3>
              <p className="text-gray-600 text-sm">Always compliant</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Why Truro Residents Choose Lanora House
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              At Lanora House, whether you're clearing a student house, downsizing, dealing with probate, or managing a commercial refit — we're ready to step in and take the weight off your shoulders.
            </p>
          </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-lg text-gray-600 mb-4">
              We serve private clients, landlords, estate agents, solicitors, and commercial businesses across Truro.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Book Your Truro Clearance Today
            </h2>
            <p className="text-xl mb-8 opacity-90">
              Ready to clear that space and start fresh? Contact Lanora House today for fast, professional clearance in Truro.
            </p>
            ...
            <div className="mt-12 p-6 bg-white/10 rounded-lg backdrop-blur-sm">
              <h3 className="text-2xl font-bold mb-4">Book a Local, Ethical Clearance Team in Truro</h3>
              <p className="text-lg opacity-90">
                Clear your property the right way – with Lanora House.
              </p>
            </div>
          </motion.div>
        </div>
...
export default TruroClearancePage;