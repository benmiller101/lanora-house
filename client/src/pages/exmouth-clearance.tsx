...
const ExmouthClearancePage = () => {
  ...
  const handleQuoteSubmit = (e: React.FormEvent) => {
    ...
    // Add service type
    formData.append('serviceType', 'exmouth-clearance');
    formData.append('location', 'Exmouth');
  ...
  const services = [
    ...
    },
    {
      ...
      title: "Furniture, Appliances, Beds, Sofas & White Goods",
      description: "Large household item removal",
      highlight: "Heavy items"
    },
    {
      icon: <Building className="w-8 h-8 text-purple-600" />,
      title: "Lofts, Garages, Basements, Sheds & Attics",
    ...
    },
    {
      ...
      title: "Garden Waste & Green Clearouts",
    ...
    },
    {
      ...
      title: "Hoarded Homes & Cluttered Spaces",
  ...
  const whyChooseUs = [
    {
      ...
      title: "Devon-Based Team",
      description: "Fast, local and reliable"
    },
    {
      icon: <Shield className="w-6 h-6 text-green-600" />,
      title: "Fully Licensed & Insured",
      description: "For all clearance types"
    },
    {
      icon: <Truck className="w-6 h-6 text-blue-600" />,
      title: "Our Own Trucks & Uniformed Staff",
      description: "No outsourcing"
    },
    {
      icon: <Users className="w-6 h-6 text-red-600" />,
      title: "Compassionate, Non-Judgmental Service",
    ...
    },
    {
      ...
      description: "Including urgent and weekend bookings"
    }
  ];
  ...
  const clientTypes = [
    ...
    },
    {
      ...
      title: "Families Dealing with Probate or Bereavement",
      description: "Estate clearances"
    },
    {
      icon: <Building className="w-6 h-6 text-green-600" />,
      title: "Letting Agents, Landlords & Estate Agents",
      description: "Property management"
    },
    {
      icon: <Building className="w-6 h-6 text-purple-600" />,
      title: "Shops, Offices & Small Businesses",
      description: "Commercial clearances"
    },
    {
      icon: <Shield className="w-6 h-6 text-indigo-600" />,
      title: "Local Authorities, Care Providers & Social Housing Teams",
      description: "Support services"
    }
  ];

  const nearbyAreas = [
    "Budleigh Salterton", "Lympstone", "Topsham", "Ottery St Mary", "Sidmouth", "East Devon"
  ];

  const faqs = [
    {
      question: "Do you offer probate clearances in Exmouth?",
      answer: "Yes – we work with solicitors and families to manage estate clearances with sensitivity and care."
    },
    {
      question: "Can you handle large or hoarded properties?",
      answer: "Absolutely – our team is trained, experienced, and always discreet."
    },
    {
      question: "What happens to the furniture and items?",
      answer: "We donate what we can, recycle most, and dispose of the rest legally — landfill is always the last resort."
    },
    {
      question: "How quickly can you clear a property?",
      answer: "Often within 24–48 hours, depending on the job. Contact us for availability."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-blue-50">
      <Helmet>
        <title>House Clearance Exmouth East Devon - Professional Property Clearance | Lanora House</title>
        <meta name="description" content="Efficient and ethical house clearance in Exmouth and East Devon with zero-to-landfill and no hidden fees. Local, respectful and professional clearance services." />
        <meta name="keywords" content="house clearance Exmouth, property clearance Exmouth Devon, probate clearance Exmouth, office clearance Exmouth, waste removal Exmouth" />
        <meta property="og:title" content="House Clearance Exmouth East Devon | Lanora House" />
        <meta property="og:description" content="Professional clearance services in Exmouth. Local team with eco-conscious approach and flexible scheduling including urgent bookings." />
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-primary bg-clip-text text-transparent">
              ...
              <span className="text-3xl md:text-5xl flex items-center justify-center gap-3 flex-wrap">
                House Clearance
                <span className="text-2xl md:text-3xl text-gray-600 font-normal">Exmouth</span>
              </span>
            </h1>
            <p className="text-xl text-gray-600 mb-4 max-w-3xl mx-auto">
              Need a property cleared in Exmouth? Whether it's a family home, a probate estate, a rental changeover, or a hoarded property, Lanora House offers local, respectful and professional house clearance services in Exmouth — delivered on time and with care.
            </p>
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              We're fully licensed waste carriers and proud to serve East Devon with a personal touch and an eco-conscious approach.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Dialog open={isQuoteDialogOpen} onOpenChange={setIsQuoteDialogOpen}>
                ...
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                  <DialogHeader>
                    <DialogTitle className="text-2xl text-primary">Get Your Free Exmouth Clearance Quote</DialogTitle>
                  </DialogHeader>
                  <form onSubmit={handleQuoteSubmit} className="space-y-6">
                      ...
                      <div>
                        ...
                        <Select value={quoteForm.propertyType} onValueChange={(value) => handleInputChange("propertyType", value)}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="jurassic-coast-property">Jurassic Coast Property</SelectItem>
                    ...
                    <div>
                      <Label htmlFor="address">Property Address in Exmouth *</Label>
                      <Input
                        id="address"
                        required
                        value={quoteForm.address}
                        onChange={(e) => handleInputChange("address", e.target.value)}
                        placeholder="Enter full address in Exmouth area"
                      />
                    </div>
                      ...
                      <div>
                        ...
                        <Select value={quoteForm.clearanceType} onValueChange={(value) => handleInputChange("clearanceType", value)}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="furniture-appliances-beds-sofas">Furniture, Appliances, Beds, Sofas & White Goods</SelectItem>
                            <SelectItem value="loft-garage-basement-shed">Lofts, Garages, Basements, Sheds & Attics</SelectItem>
                            <SelectItem value="garden-green">Garden Waste & Green Clearouts</SelectItem>
                            <SelectItem value="probate-estate-property">Probate & Estate Property Clearance</SelectItem>
                            <SelectItem value="hoarded-cluttered">Hoarded Homes & Cluttered Spaces</SelectItem>
                            <SelectItem value="retail-office">Retail & Office Clearance</SelectItem>
                            <SelectItem value="electronic-weee">WEEE & Electronics Disposal</SelectItem>
                            <SelectItem value="hazardous-biohazards">Hazardous Waste & Biohazards</SelectItem>
                            <SelectItem value="wait-load-emergency">Wait & Load & Emergency Removals</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      <div>
                        ...
                        <Select value={quoteForm.timeframe} onValueChange={(value) => handleInputChange("timeframe", value)}>
                          ...
                          <SelectContent>
                            <SelectItem value="urgent-bookings">Urgent Bookings</SelectItem>
                            <SelectItem value="weekend-bookings">Weekend Bookings</SelectItem>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Any parking restrictions, narrow coastal roads, stairs, or other access issues in Exmouth we should know about?"
                        rows={3}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Tell us more about your clearance requirements in Exmouth"
                        rows={4}
                      />
                    </div>
      ...
      {/* Exmouth Location Showcase Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <Badge className="mb-4 bg-primary/20 text-primary border-primary/30">
                <Mountain className="w-4 h-4 mr-1" />
                Proudly Serving Exmouth
              </Badge>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">
                East Devon's
                <br />
                <span className="text-2xl md:text-3xl text-gray-700">Gateway to the Jurassic Coast</span>
              </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                  ...
                  <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Eco-conscious approach</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="bg-blue-50 rounded-2xl p-6 shadow-lg">
                <div className="text-center mb-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Find Us in Exmouth</h3>
                  <p className="text-gray-600">Gateway to the Jurassic Coast, East Devon</p>
                </div>
                
                {/* Embedded Google Maps */}
                <div className="relative rounded-xl overflow-hidden shadow-md bg-gray-200 h-80">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d20374.955049556546!2d-3.4133!3d50.6172!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x486c385b385b385b%3A0x4b9b8b4b0c5d0e!2sExmouth%2C%20UK!5e0!3m2!1sen!2suk!4v1620000000000!5m2!1sen!2suk"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
                ...
                <div className="mt-6 p-4 bg-white rounded-xl shadow-sm border">
                  ...
                  <div className="text-sm text-gray-600 space-y-2">
                    <div>🌍 <strong>UNESCO Gateway:</strong> Gateway to the Jurassic Coast World Heritage Site</div>
                    <div>🦕 <strong>Fossil Famous:</strong> Famous for fossils and 185 million years of geological history</div>
                    <div>⛰️ <strong>Geological Wonder:</strong> Part of England's first natural World Heritage Site</div>
                    <div>🌊 <strong>Coastal Heritage:</strong> Historic seaside resort on the East Devon coast</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-blue-100 text-blue-800 border-blue-300">
              ...
              What We Clear in Exmouth
            </Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Complete Clearance Services
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From one room to full property clearance — we handle it all, start to finish.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-green-50">
        <div className="max-w-4xl mx-auto text-center">
          <Badge className="mb-4 bg-green-100 text-green-800 border-green-300">
            ...
            Eco-Friendly Clearance You Can Trust
          </Badge>
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">
            We Aim to Protect the Planet as We Clear
          </h2>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            We ensure your clearance is clean, legal, and low-impact.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-bold text-lg mb-2">Maximum Recycling</h3>
              <p className="text-gray-600 text-sm">With detailed waste sorting</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
              ...
              <p className="text-gray-600 text-sm">To East Devon charities</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
              ...
              <p className="text-gray-600 text-sm">Of furniture and goods</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-lg mb-2">Full Legal Documentation</h3>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Why Exmouth Chooses Lanora House
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We're here to make your clearance stress-free and straightforward.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Whatever your situation — we're ready to help, respectfully and professionally.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Book a House Clearance in Exmouth Today
            </h2>
            <p className="text-xl mb-8 opacity-90">
              Clear your space the easy way – with Lanora House. Get a fast, no-obligation quote today.
            </p>
            ...
            <div className="mt-12 p-6 bg-white/10 rounded-lg backdrop-blur-sm">
              <h3 className="text-2xl font-bold mb-4">House Clearance Exmouth – Professional, Affordable & Green</h3>
              <p className="text-lg opacity-90">
                Clear your space with confidence – choose Lanora House for local service that delivers.
              </p>
            </div>
          </motion.div>
        </div>
...
export default ExmouthClearancePage;