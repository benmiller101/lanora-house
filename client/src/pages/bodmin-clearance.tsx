...
const BodminClearancePage = () => {
  ...
  const handleQuoteSubmit = (e: React.FormEvent) => {
    ...
    // Add service type
    formData.append('serviceType', 'bodmin-clearance');
    formData.append('location', 'Bodmin');
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Quick removals and flexible collection",
  ...
  const whyChooseUs = [
    {
      ...
      title: "Local Team",
      description: "Fast response times in North Cornwall"
    },
    {
      icon: <Shield className="w-6 h-6 text-green-600" />,
      title: "Licensed & Insured",
      description: "Fully licensed and insured waste carriers"
    },
    {
      icon: <Truck className="w-6 h-6 text-blue-600" />,
      title: "Own Staff & Trucks",
      description: "No subcontractors"
    },
    {
      icon: <Users className="w-6 h-6 text-purple-600" />,
      title: "Respectful & Discreet",
      description: "Especially for sensitive situations"
    },
    {
  ...
  const clientTypes = [
    {
      ...
      title: "Families & Private Homeowners",
    ...
    },
    {
      ...
      title: "Commercial & Retail Businesses",
      description: "Business clearances"
    },
    {
      icon: <Shield className="w-6 h-6 text-indigo-600" />,
      title: "Vulnerable Individuals & Social Support",
      description: "Professional support services"
    }
  ];

  const nearbyAreas = [
    "Lanivet", "Lostwithiel", "Wadebridge", "Blisland", "St Austell", "Liskeard"
  ];

  const faqs = [
    {
      question: "How soon can you clear a property in Bodmin?",
      answer: "Often within 1–2 days. Urgent slots may be available — contact us to check."
    },
    {
      question: "Do you clear hoarded properties or severe clutter?",
      answer: "Yes — our team is experienced, non-judgmental, and handles these jobs with care and discretion."
    },
    {
      question: "Can you provide documentation for probate purposes?",
      answer: "Absolutely. We can provide photos, inventories, and all required waste transfer notes."
    },
    {
      question: "What happens to valuable or reusable items?",
      answer: "We'll identify anything with resale value and either return it, donate it, or help you sell it."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-blue-50">
      <Helmet>
        <title>House Clearance Bodmin North Cornwall - Professional Property Clearance | Lanora House</title>
        <meta name="description" content="Fast, discreet property clearance services in Bodmin and North Cornwall – done the right way. Efficient, respectful, and environmentally responsible." />
        <meta name="keywords" content="house clearance Bodmin, property clearance Bodmin Cornwall, probate clearance Bodmin, office clearance Bodmin, waste removal Bodmin" />
        <meta property="og:title" content="House Clearance Bodmin North Cornwall | Lanora House" />
        <meta property="og:description" content="Professional clearance services in Bodmin. Local Cornwall-based team with fast response times and eco-conscious approach." />
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-primary bg-clip-text text-transparent">
              ...
              <span className="text-3xl md:text-5xl flex items-center justify-center gap-3 flex-wrap">
                Property Clearance
                <span className="text-2xl md:text-3xl text-gray-600 font-normal">Bodmin</span>
              </span>
            </h1>
            <p className="text-xl text-gray-600 mb-4 max-w-3xl mx-auto">
              If you need a house or business premises cleared in Bodmin, Lanora House is here to help. Whether you're dealing with a probate property, moving house, clearing out years of clutter, or managing a rental turnover — we offer efficient, respectful, and environmentally responsible clearance services.
            </p>
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              We're based in Cornwall, fully licensed and insured, and committed to helping you clear your space without stress. <a href="tel:+447843930927" className="text-primary hover:underline">Call us today</a> for immediate assistance.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Dialog open={isQuoteDialogOpen} onOpenChange={setIsQuoteDialogOpen}>
                ...
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                  <DialogHeader>
                    <DialogTitle className="text-2xl text-primary">Get Your Free Bodmin Clearance Quote</DialogTitle>
                  </DialogHeader>
                  <form onSubmit={handleQuoteSubmit} className="space-y-6">
                      ...
                      <div>
                        ...
                        <Select value={quoteForm.propertyType} onValueChange={(value) => handleInputChange("propertyType", value)}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="probate-property">Probate Property</SelectItem>
                    ...
                    <div>
                      <Label htmlFor="address">Property Address in Bodmin *</Label>
                      <Input
                        id="address"
                        required
                        value={quoteForm.address}
                        onChange={(e) => handleInputChange("address", e.target.value)}
                        placeholder="Enter full address in Bodmin area"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Select value={quoteForm.clearanceType} onValueChange={(value) => handleInputChange("clearanceType", value)}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="garden-sheds-garages">Garden Sheds, Garages, Attics & Basements</SelectItem>
                            <SelectItem value="furniture-white-goods">Furniture, White Goods, Sofas, Mattresses</SelectItem>
                            <SelectItem value="office-retail-commercial">Office, Retail & Commercial Clearouts</SelectItem>
                            <SelectItem value="probate-estate">Probate & Estate Clearance</SelectItem>
                            <SelectItem value="hoarder-home">Hoarder Home Support</SelectItem>
                      ...
                      <div>
                        ...
                        <Select value={quoteForm.timeframe} onValueChange={(value) => handleInputChange("timeframe", value)}>
                          ...
                          <SelectContent>
                            <SelectItem value="urgent">Urgent (check availability)</SelectItem>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Any parking restrictions, narrow access, stairs, or other access issues in Bodmin we should know about?"
                        rows={3}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Any sensitive situations, probate clearances, hoarding support, need for documentation, or discretion?"
                        rows={3}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Tell us more about your clearance requirements in Bodmin"
                        rows={4}
                      />
                    </div>
      ...
      {/* Bodmin Location Showcase Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <Badge className="mb-4 bg-primary/20 text-primary border-primary/30">
                <Castle className="w-4 h-4 mr-1" />
                Proudly Serving Bodmin
              </Badge>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">
                North Cornwall's
                <br />
                <span className="text-2xl md:text-3xl text-gray-700">Historic County Town</span>
              </h2>
              <div className="space-y-4 text-gray-600">
                <p className="text-lg leading-relaxed">
                  <strong className="text-primary">Cornwall-based specialists</strong> serving Bodmin and North Cornwall. We understand this historic town and its unique clearance needs.
                </p>
                <p className="leading-relaxed">
                  From the town center to the surrounding areas, from historic properties to modern developments, we provide trusted clearance services throughout Bodmin and the surrounding area.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                  <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900">1-2 Day Service</div>
                      <div className="text-sm text-gray-600">Urgent slots available</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Responsible disposal</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="bg-blue-50 rounded-2xl p-6 shadow-lg">
                <div className="text-center mb-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Find Us in Bodmin</h3>
                  <p className="text-gray-600">Historic County Town, North Cornwall</p>
                </div>
                
                {/* Embedded Google Maps */}
                <div className="relative rounded-xl overflow-hidden shadow-md bg-gray-200 h-80">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d10187.477524778273!2d-4.7239!3d50.4669!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x486ab2e5e5e5e5e5%3A0x404c6d0fb97d9b!2sBodmin%2C%20UK!5e0!3m2!1sen!2suk!4v1620000000000!5m2!1sen!2suk"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
                ...
                <div className="mt-6 p-4 bg-white rounded-xl shadow-sm border">
                  ...
                  <div className="text-sm text-gray-600 space-y-2">
                    <div>🏰 <strong>Historic Jail:</strong> Bodmin Jail, built in 1779, was one of the first modern prisons in the UK</div>
                    <div>👻 <strong>Most Haunted:</strong> Rumoured to be one of the most haunted places in Cornwall</div>
                    <div>📍 <strong>County Town:</strong> Historic administrative center of Cornwall</div>
                    <div>🏘️ <strong>North Cornwall Hub:</strong> Perfect central location for surrounding areas</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-blue-100 text-blue-800 border-blue-300">
              ...
              What We Clear in Bodmin
            </Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Complete Clearance Services
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              No matter the size or condition of the property, we get the job done with care.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-green-50">
        <div className="max-w-4xl mx-auto text-center">
          <Badge className="mb-4 bg-green-100 text-green-800 border-green-300">
            ...
            Responsible Waste Disposal in Bodmin
          </Badge>
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">
            Protecting Cornwall's Environment
          </h2>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Lanora House follows a zero-to-landfill policy to protect Cornwall's beautiful environment. We don't just remove waste — we manage it responsibly from start to finish.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">As much material as possible</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Goods on your behalf</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
              ...
              <p className="text-gray-600 text-sm">Waste transfer documentation</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
              ...
              <p className="text-gray-600 text-sm">Hazardous waste</p>
            </div>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Why Choose Lanora House in Bodmin?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Whether it's a small one-off job or a full estate clearance, we're here to make it simple.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Who We Help in Bodmin
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We tailor our service to your needs — always with compassion and professionalism.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-blue-50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">
            Areas We Also Cover Near Bodmin
          </h2>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Book Your House Clearance in Bodmin
            </h2>
            <p className="text-xl mb-8 opacity-90">
              Don't stress about your next clearance — let us handle it. Contact us today for a free, no-obligation quote.
            </p>
            ...
            <div className="mt-12 p-6 bg-white/10 rounded-lg backdrop-blur-sm">
              <h3 className="text-2xl font-bold mb-4">Clear Space with Confidence – Choose Lanora House Bodmin</h3>
              <p className="text-lg opacity-90">
                Professional clearance with care, respect, and eco-conscious values.
              </p>
            </div>
          </motion.div>
        </div>
...
export default BodminClearancePage;