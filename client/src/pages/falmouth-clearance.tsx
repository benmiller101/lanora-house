...
const FalmouthClearancePage = () => {
  ...
  const handleQuoteSubmit = (e: React.FormEvent) => {
    ...
    // Add service type
    formData.append('serviceType', 'falmouth-clearance');
    formData.append('location', 'Falmouth');
  ...
  const services = [
    ...
    },
    {
      ...
      title: "Garage, Loft & Basement Clearouts",
      description: "Specialized storage space clearances",
      highlight: "Space experts"
    },
    {
      icon: <TreePine className="w-8 h-8 text-green-600" />,
      title: "Garden Waste & Shed Removal",
    ...
    },
    {
      ...
      description: "Commercial property clearances",
    ...
    },
    {
      ...
      title: "Hoarded Properties & Deep Clutter",
      description: "Non-judgmental support for severe clutter",
      highlight: "Empathetic service"
    },
    {
    ...
    },
    {
      ...
      title: "Wait & Load Waste Services",
      description: "Flexible waste collection options",
  ...
  const whyChooseUs = [
    {
      ...
      description: "At Lanora House, we live and work in Cornwall, treating every clearance like our own"
    },
    {
      icon: <Clock className="w-6 h-6 text-blue-600" />,
      title: "Fast Quotes & Flexible Scheduling",
      description: "Often within 24–48 hours depending on availability"
    },
    {
      icon: <Truck className="w-6 h-6 text-green-600" />,
      title: "Own Trucks – No Subcontractors",
      description: "Direct service with our own trained team"
    },
    {
      icon: <Shield className="w-6 h-6 text-purple-600" />,
      title: "Fully Licensed & Insured",
      description: "Licensed waste carriers operating to UK regulations"
    },
    {
      icon: <Users className="w-6 h-6 text-green-700" />,
      title: "Friendly, Discreet, Professional",
      description: "Residential & commercial clients welcome"
    }
  ];

  const nearbyAreas = [
    "Penryn", "Mabe Burnthouse", "Treluswell", "Helston", "Redruth", "West Cornwall"
  ];

  const faqs = [
    {
      question: "How fast can you clear a property in Falmouth?",
      answer: "Often within 24–48 hours depending on availability. Contact us for urgent requests."
    },
    {
      question: "Do you handle probate or sensitive situations?",
      answer: "Yes – we work with families, solicitors, and executors across Cornwall, offering compassionate support."
    },
    {
      question: "Can you help with hoarded homes?",
      answer: "Absolutely. Our team is experienced, non-judgmental, and works with empathy."
    },
    {
      question: "What happens to the items you take?",
      answer: "We recycle and donate as much as possible. Valuable items may be appraised and sold for you."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-blue-50">
      <Helmet>
        <title>Professional House Clearance Falmouth Cornwall - Trusted Local Team | Lanora House</title>
        <meta name="description" content="Lanora House provides expert house clearance services in Falmouth and surrounding areas. Cornwall's trusted clearance team offering fast, eco-conscious, reliable service." />
        <meta name="keywords" content="house clearance Falmouth, property clearance Falmouth Cornwall, probate clearance Falmouth, office clearance Falmouth, waste removal Falmouth" />
        <meta property="og:title" content="Professional House Clearance Falmouth Cornwall | Lanora House" />
        <meta property="og:description" content="Expert house clearance services in Falmouth. Trusted local team with eco-conscious approach and fast response times." />
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-primary bg-clip-text text-transparent">
              ...
              <span className="text-3xl md:text-5xl flex items-center justify-center gap-3 flex-wrap">
                The Right Way
                <span className="text-2xl md:text-3xl text-gray-600 font-normal">Falmouth</span>
              </span>
            </h1>
            <p className="text-xl text-gray-600 mb-4 max-w-3xl mx-auto">
              Whether you're moving home, renovating, dealing with a bereavement, or just need a fresh start, Lanora House offers expert house clearance services in Falmouth and the surrounding areas.
            </p>
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              We're a Cornwall-based team with deep local roots and a strong reputation for reliable, eco-conscious clearances — from small one-room jobs to full estates and commercial properties. <Link href="/contact" className="text-primary hover:underline">Get in touch</Link> to discuss your needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Dialog open={isQuoteDialogOpen} onOpenChange={setIsQuoteDialogOpen}>
                ...
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                  <DialogHeader>
                    <DialogTitle className="text-2xl text-primary">Get Your Free Falmouth Clearance Quote</DialogTitle>
                  </DialogHeader>
                  <form onSubmit={handleQuoteSubmit} className="space-y-6">
                    ...
                    <div>
                      <Label htmlFor="address">Property Address in Falmouth *</Label>
                      <Input
                        id="address"
                        required
                        value={quoteForm.address}
                        onChange={(e) => handleInputChange("address", e.target.value)}
                        placeholder="Enter full address in Falmouth"
                      />
                    </div>
                      ...
                      <div>
                        ...
                        <Select value={quoteForm.clearanceType} onValueChange={(value) => handleInputChange("clearanceType", value)}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="garden-shed">Garden Waste & Shed Removal</SelectItem>
                            ...
                            <SelectItem value="hoarded-property">Hoarded Property & Deep Clutter</SelectItem>
                            <SelectItem value="wait-load">Wait & Load Waste Services</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Any parking restrictions, narrow access, stairs, or other access issues in Falmouth we should know about?"
                        rows={3}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Any sensitive items, hazardous materials, or other specific requirements?"
                        rows={3}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Tell us more about your clearance requirements in Falmouth"
                        rows={4}
                      />
                    </div>
      ...
      {/* Falmouth Location Showcase Section */}
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                <p className="text-lg leading-relaxed">
                  <strong className="text-primary">Deep local roots</strong> in Falmouth and West Cornwall. We understand the unique character of this historic maritime town and its clearance needs.
                </p>
                <p className="leading-relaxed">
                  From the bustling town center to the waterfront properties, from student accommodations near Falmouth University to family homes in the surrounding villages, we provide trusted clearance services throughout the area.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                  ...
                  <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900">Eco-Conscious</div>
                      <div className="text-sm text-gray-600">Zero-to-landfill policy</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="bg-blue-50 rounded-2xl p-6 shadow-lg">
                <div className="text-center mb-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Find Us in Falmouth</h3>
                  <p className="text-gray-600">Historic Maritime Town, Cornwall</p>
                </div>
                
                {/* Embedded Google Maps */}
                <div className="relative rounded-xl overflow-hidden shadow-md bg-gray-200 h-80">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d10147.477524778273!2d-5.0711!3d50.1534!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x486ab5e5e5e5e5e5%3A0x404c6d0fb97d9b!2sFalmouth%2C%20UK!5e0!3m2!1sen!2suk!4v1620000000000!5m2!1sen!2suk"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
                ...
                <div className="mt-6 p-4 bg-white rounded-xl shadow-sm border">
                  ...
                  <div className="text-sm text-gray-600 space-y-2">
                    <div>⚓ <strong>Third Deepest Harbour:</strong> Falmouth Harbour is the world's third deepest natural harbour</div>
                    <div>🚢 <strong>Maritime Heritage:</strong> Key role in global maritime trade and naval history</div>
                    <div>🎓 <strong>University Town:</strong> Home to Falmouth University with vibrant student community</div>
                    <div>🌊 <strong>Coastal Beauty:</strong> Gateway to some of Cornwall's most stunning beaches</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-blue-100 text-blue-800 border-blue-300">
              ...
              What We Clear in Falmouth
            </Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Complete Clearance Services
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We handle everything from common household junk to the most sensitive and specialist clearances with care and respect. Including hazardous waste and animal remains.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-green-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">
            Ethical Waste Disposal in Falmouth
          </h2>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Lanora House is proud to support a zero-to-landfill approach. We work hard to recycle, repurpose, or donate as much as possible, and we're committed to reducing environmental impact while helping our clients responsibly clear their spaces.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-bold text-lg mb-2">Sort & Log</h3>
              <p className="text-gray-600 text-sm">All waste types</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-lg mb-2">Appraise & Sell</h3>
              <p className="text-gray-600 text-sm">Valuable goods on your behalf</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
                <Shield className="w-8 h-8 text-blue-600" />
              </div>
              <h3 className="font-bold text-lg mb-2">Waste Reports</h3>
              <p className="text-gray-600 text-sm">Transfer & audit trails</p>
            </div>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Why Choose Lanora House in Falmouth?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              At Lanora House, we're not a national chain or faceless company. We live and work in Cornwall, and we treat every clearance like it's our own.
            </p>
          </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-lg text-gray-600 mb-4">
              Serving families, landlords & businesses in Falmouth. Whether you're a landlord preparing for new tenants, a family managing a probate property, or a business refurbishing your space — we can help you clear out quickly, safely, and affordably.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Get Your Free House Clearance Quote in Falmouth
            </h2>
            <p className="text-xl mb-8 opacity-90">
              Book with a friendly local team who genuinely cares about your property and your peace of mind.
            </p>
            ...
            <div className="mt-12 p-6 bg-white/10 rounded-lg backdrop-blur-sm">
              <h3 className="text-2xl font-bold mb-4">Trusted House Clearance in Falmouth – Book Now</h3>
              <p className="text-lg opacity-90">
                Clear your space. Reclaim your peace of mind. Do it with Lanora House.
              </p>
            </div>
          </motion.div>
        </div>
...
export default FalmouthClearancePage;