...
const PlymouthClearancePage = () => {
  ...
  const handleQuoteSubmit = (e: React.FormEvent) => {
    ...
    // Add service type
    formData.append('serviceType', 'plymouth-clearance');
    formData.append('location', 'Plymouth');
  ...
  const services = [
    ...
    },
    {
      ...
      title: "Lofts, Attics, Garages & Basements",
    ...
    },
    {
      ...
      title: "Furniture, Sofas, Beds, White Goods & Bulky Items",
    ...
    },
    {
      ...
      description: "Handled with care and understanding",
      highlight: "Expert help"
    },
    {
      icon: <Building className="w-8 h-8 text-indigo-600" />,
      title: "Retail, Commercial & Office Clearouts",
  ...
  const whyChooseUs = [
    {
      ...
      description: "Fast service across Devon"
    },
    {
  ...
  const clientTypes = [
    ...
    },
    {
      ...
      title: "Probate Solicitors & Estate Executors",
    ...
    },
    {
      ...
      title: "Housing Support Services & Councils",
      description: "Support agencies"
    }
  ];

  const nearbyAreas = [
    "Saltash", "Torpoint", "Ivybridge", "Plympton", "Plymstock", "Tavistock", "South Hams"
  ];

  const faqs = [
    {
      question: "Do you offer probate clearances in Plymouth?",
      answer: "Yes – we work closely with families and solicitors to respectfully manage estate clearances."
    },
    {
      question: "Can you clear out commercial premises or offices?",
      answer: "Absolutely. We're fully equipped for large-scale office, retail, and warehouse clearouts."
    },
    {
      question: "What happens to items once removed?",
      answer: "We recycle, donate, and resell where possible. All waste is processed legally and ethically."
    },
    {
      question: "Can you help with hoarded properties?",
      answer: "Yes – we are experienced, non-judgmental, and handle even the most difficult clearances with compassion."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-blue-50">
      <Helmet>
        <title>House Clearance Plymouth South Devon - Professional Property Clearance | Lanora House</title>
        <meta name="description" content="Lanora House provides trusted property clearance for homes and businesses in Plymouth and across South Devon. Reliable, affordable house clearance with zero-to-landfill practices." />
        <meta name="keywords" content="house clearance Plymouth, property clearance Plymouth Devon, probate clearance Plymouth, office clearance Plymouth, waste removal Plymouth" />
        <meta property="og:title" content="House Clearance Plymouth South Devon | Lanora House" />
        <meta property="og:description" content="Lanora House provides professional clearance services in Plymouth. South West based team with ethical waste disposal and flexible booking." />
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-primary bg-clip-text text-transparent">
              ...
              <span className="text-3xl md:text-5xl flex items-center justify-center gap-3 flex-wrap">
                House Clearance
                <span className="text-2xl md:text-3xl text-gray-600 font-normal">Plymouth</span>
              </span>
            </h1>
            <p className="text-xl text-gray-600 mb-4 max-w-3xl mx-auto">
              Looking for reliable, affordable house clearance in Plymouth? Whether you're managing a probate estate, moving out, renovating, or clearing a cluttered space — Lanora House offers a friendly, fast, and fully licensed clearance service tailored to your needs.
            </p>
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              We handle jobs big and small, and we're committed to zero-to-landfill, ethical waste disposal across Devon and Cornwall. <a href="tel:+447456809049" className="text-primary hover:underline">Speak to our experts</a> about your clearance needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Dialog open={isQuoteDialogOpen} onOpenChange={setIsQuoteDialogOpen}>
                ...
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                  <DialogHeader>
                    <DialogTitle className="text-2xl text-primary">Get Your Free Plymouth Clearance Quote</DialogTitle>
                  </DialogHeader>
                  <form onSubmit={handleQuoteSubmit} className="space-y-6">
                      ...
                      <div>
                        ...
                        <Select value={quoteForm.propertyType} onValueChange={(value) => handleInputChange("propertyType", value)}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="three-storey">Three-Storey Property</SelectItem>
                    ...
                    <div>
                      <Label htmlFor="address">Property Address in Plymouth *</Label>
                      <Input
                        id="address"
                        required
                        value={quoteForm.address}
                        onChange={(e) => handleInputChange("address", e.target.value)}
                        placeholder="Enter full address in Plymouth area"
                      />
                    </div>
                      ...
                      <div>
                        ...
                        <Select value={quoteForm.clearanceType} onValueChange={(value) => handleInputChange("clearanceType", value)}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="loft-garage-basement">Lofts, Attics, Garages & Basements</SelectItem>
                            <SelectItem value="garden-shed">Garden Waste & Shed Dismantling</SelectItem>
                            <SelectItem value="furniture-bulky">Furniture, Sofas, Beds, White Goods & Bulky Items</SelectItem>
                            ...
                            <SelectItem value="commercial-office">Retail, Commercial & Office Clearouts</SelectItem>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Any parking restrictions, narrow city roads, stairs, or other access issues in Plymouth we should know about?"
                        rows={3}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Tell us more about your clearance requirements in Plymouth"
                        rows={4}
                      />
                    </div>
      ...
      {/* Plymouth Location Showcase Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <Badge className="mb-4 bg-primary/20 text-primary border-primary/30">
                <Ship className="w-4 h-4 mr-1" />
                Proudly Serving Plymouth
              </Badge>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">
                South Devon's
                <br />
                <span className="text-2xl md:text-3xl text-gray-700">Historic Ocean City</span>
              </h2>
              <div className="space-y-4 text-gray-600">
                <p className="text-lg leading-relaxed">
                  <strong className="text-primary">South West specialists</strong> serving Plymouth and across South Devon. We understand this historic ocean city and its unique clearance needs.
                </p>
                <p className="leading-relaxed">
                  From the city center to the waterfront, from one-bedroom flats to three-storey properties, we provide trusted clearance services throughout Plymouth and the surrounding area.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                  <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Across Devon</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Ethical practices</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="bg-blue-50 rounded-2xl p-6 shadow-lg">
                <div className="text-center mb-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Find Us in Plymouth</h3>
                  <p className="text-gray-600">Historic Ocean City, South Devon</p>
                </div>
                
                {/* Embedded Google Maps */}
                <div className="relative rounded-xl overflow-hidden shadow-md bg-gray-200 h-80">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d20374.955049556546!2d-4.1436!3d50.3755!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x486c93516bbf8c91%3A0x1dd7c2985c8de8d7!2sPlymouth%2C%20UK!5e0!3m2!1sen!2suk!4v1620000000000!5m2!1sen!2suk"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
                ...
                <div className="mt-6 p-4 bg-white rounded-xl shadow-sm border">
                  ...
                  <div className="text-sm text-gray-600 space-y-2">
                    <div>⛵ <strong>Mayflower Departure:</strong> Famous departure point of the Mayflower in 1620</div>
                    <div>🏛️ <strong>Historic Journey:</strong> Carried the Pilgrims to America, shaping modern history</div>
                    <div>🌊 <strong>Ocean City:</strong> Britain's historic ocean city with stunning waterfront</div>
                    <div>⚓ <strong>Naval Heritage:</strong> Home to the largest naval base in Western Europe</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-blue-100 text-blue-800 border-blue-300">
              ...
              What We Clear in Plymouth
            </Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Complete Clearance Services
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We're here to make your space clean, clear, and ready for whatever comes next.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-green-50">
        <div className="max-w-4xl mx-auto text-center">
          <Badge className="mb-4 bg-green-100 text-green-800 border-green-300">
            ...
            Responsible House Clearance in Plymouth
          </Badge>
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">
            Eco-Conscious Clearance Services
          </h2>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Our aim is simple: clear your space, not your conscience.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-lg mb-2">Appraising & Reselling</h3>
              <p className="text-gray-600 text-sm">Valuables upon request</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Waste transfer paperwork</p>
            </div>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Why Choose Lanora House in Plymouth?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              At Lanora House, whether it's a one-bedroom flat or a three-storey office, we're ready to help.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We adapt our service to your needs — and handle every job with dignity and respect.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Book House Clearance in Plymouth Today
            </h2>
            <p className="text-xl mb-8 opacity-90">
              Get your space cleared the right way — quickly, affordably, and responsibly. Contact us for a free quote today.
            </p>
            ...
            <div className="mt-12 p-6 bg-white/10 rounded-lg backdrop-blur-sm">
              <h3 className="text-2xl font-bold mb-4">The Easy, Ethical Way to Clear Your Space in Plymouth</h3>
              <p className="text-lg opacity-90">
                Quick. Clean. Conscious. Book your house clearance with Lanora House today.
              </p>
            </div>
          </motion.div>
        </div>
...
export default PlymouthClearancePage;