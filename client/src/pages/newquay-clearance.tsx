...
const NewquayClearancePage = () => {
  ...
  const handleQuoteSubmit = (e: React.FormEvent) => {
    ...
    // Add service type
    formData.append('serviceType', 'newquay-clearance');
    formData.append('location', 'Newquay');
  ...
  const services = [
    ...
    },
    {
      ...
      title: "Garage, Loft & Attic Clearouts",
      description: "Storage space clearances and organization",
  ...
  const whyChooseUs = [
    {
      ...
      title: "Local Cornwall-Based Team",
      description: "Fast response times in North Cornwall"
    },
    {
      icon: <Truck className="w-6 h-6 text-blue-600" />,
      title: "Own Trucks & Equipment",
      description: "No outsourcing – our own staff and vehicles"
    },
    {
    ...
    },
    {
      ...
      description: "Respectful service for all situations"
    },
    {
      icon: <Leaf className="w-6 h-6 text-green-700" />,
      title: "Sustainable Disposal",
      description: "Eco-conscious waste management"
    }
  ];
  ...
  const clientTypes = [
    ...
    },
    {
      ...
      description: "End-of-tenancy clearances"
    },
    {
      icon: <Heart className="w-6 h-6 text-red-600" />,
      title: "Probate Families",
      description: "Estate clearances"
    },
    {
      icon: <Building className="w-6 h-6 text-purple-600" />,
      title: "Local Businesses",
      description: "Retailers and offices"
    },
    {
      icon: <Shield className="w-6 h-6 text-indigo-600" />,
      title: "Social Services",
      description: "Vulnerable individuals support"
    }
  ];

  const nearbyAreas = [
    "Crantock", "Quintrell Downs", "St Columb Minor", "St Columb Major", "Mawgan Porth", "Perranporth", "North Cornwall"
  ];

  const faqs = [
    {
      question: "How quickly can you clear a property in Newquay?",
      answer: "Often within 1–2 days. Contact us for urgent same-day availability."
    },
    {
      question: "Can you clear rental properties between tenancies?",
      answer: "Absolutely — we regularly work with landlords and agents for end-of-tenancy clearances."
    },
    {
      question: "Do you offer discreet services for sensitive cases?",
      answer: "Yes — we can arrive in unbranded vehicles if preferred and always treat clients with dignity."
    },
    {
      question: "What happens to the items you take?",
      answer: "They're sorted for reuse, donation, resale, and recycling. Very little goes to landfill."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-blue-50">
      <Helmet>
        <title>House Clearance Newquay North Cornwall - Professional Property Clearance | Lanora House</title>
        <meta name="description" content="Lanora House provides professional house and property clearance across Newquay and North Cornwall. Fast, respectful, environmentally responsible clearance services." />
        <meta name="keywords" content="house clearance Newquay, property clearance Newquay Cornwall, probate clearance Newquay, office clearance Newquay, waste removal Newquay" />
        <meta property="og:title" content="House Clearance Newquay North Cornwall | Lanora House" />
        <meta property="og:description" content="Professional clearance services in Newquay. Local Cornwall-based team with fast response times and eco-conscious approach." />
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-primary bg-clip-text text-transparent">
              ...
              <span className="text-3xl md:text-5xl flex items-center justify-center gap-3 flex-wrap">
                Property Clearance
                <span className="text-2xl md:text-3xl text-gray-600 font-normal">Newquay</span>
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Dialog open={isQuoteDialogOpen} onOpenChange={setIsQuoteDialogOpen}>
                ...
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                  <DialogHeader>
                    <DialogTitle className="text-2xl text-primary">Get Your Free Newquay Clearance Quote</DialogTitle>
                  </DialogHeader>
                  <form onSubmit={handleQuoteSubmit} className="space-y-6">
                    ...
                    <div>
                      <Label htmlFor="address">Property Address in Newquay *</Label>
                      <Input
                        id="address"
                        required
                        value={quoteForm.address}
                        onChange={(e) => handleInputChange("address", e.target.value)}
                        placeholder="Enter full address in Newquay area"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Select value={quoteForm.clearanceType} onValueChange={(value) => handleInputChange("clearanceType", value)}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="garden-shed">Garden Waste & Shed Disposal</SelectItem>
                            <SelectItem value="garage-loft-attic">Garage, Loft & Attic</SelectItem>
                      ...
                      <div>
                        ...
                        <Select value={quoteForm.timeframe} onValueChange={(value) => handleInputChange("timeframe", value)}>
                          ...
                          <SelectContent>
                            <SelectItem value="same-day">Same Day (urgent)</SelectItem>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Any parking restrictions, narrow access, stairs, or other access issues in Newquay we should know about?"
                        rows={3}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Any sensitive situations, valuable items, or need for unbranded vehicles?"
                        rows={3}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Tell us more about your clearance requirements in Newquay"
                        rows={4}
                      />
                    </div>
      ...
      {/* Newquay Location Showcase Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <Badge className="mb-4 bg-primary/20 text-primary border-primary/30">
                <Waves className="w-4 h-4 mr-1" />
                Proudly Serving Newquay
              </Badge>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">
                North Cornwall's
                <br />
                <span className="text-2xl md:text-3xl text-gray-700">Surfing Capital Service</span>
              </h2>
              <div className="space-y-4 text-gray-600">
                <p className="text-lg leading-relaxed">
                  <strong className="text-primary">Cornwall-based specialists</strong> serving Newquay and North Cornwall. We understand this vibrant coastal town and its unique clearance needs.
                </p>
                <p className="leading-relaxed">
                  From the town center to the coastal areas, from holiday homes to permanent residences, from student accommodations to business premises, we provide trusted clearance services throughout Newquay and the surrounding area.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                  <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">1-2 day service</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900">Eco-First</div>
                      <div className="text-sm text-gray-600">Zero-to-landfill promise</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="bg-blue-50 rounded-2xl p-6 shadow-lg">
                <div className="text-center mb-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Find Us in Newquay</h3>
                  <p className="text-gray-600">UK's Surfing Capital, North Cornwall</p>
                </div>
                
                {/* Embedded Google Maps */}
                <div className="relative rounded-xl overflow-hidden shadow-md bg-gray-200 h-80">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d10147.477524778273!2d-5.0757!3d50.4161!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x486ab2e5e5e5e5e5%3A0x404c6d0fb97d9b!2sNewquay%2C%20UK!5e0!3m2!1sen!2suk!4v1620000000000!5m2!1sen!2suk"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
                ...
                <div className="mt-6 p-4 bg-white rounded-xl shadow-sm border">
                  ...
                  <div className="text-sm text-gray-600 space-y-2">
                    <div>🏄 <strong>Surfing Capital:</strong> Newquay is often called the surfing capital of the UK</div>
                    <div>🌊 <strong>Fistral Beach:</strong> Hosts international surfing competitions worldwide</div>
                    <div>🏖️ <strong>Seven Beaches:</strong> Newquay boasts seven stunning beaches within the town</div>
                    <div>🎓 <strong>Student Town:</strong> Home to thousands of students and young professionals</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-blue-100 text-blue-800 border-blue-300">
              ...
              What We Clear in Newquay
            </Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Complete Clearance Services
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We're here for jobs big and small — from single rooms to multi-floor commercial properties.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-green-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">
            Eco-First Approach in Newquay
          </h2>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            At Lanora House, we don't just remove junk — we handle it ethically. You get a clear space — and peace of mind knowing your clearance was done responsibly.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Promise</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
                <Heart className="w-8 h-8 text-red-600" />
              </div>
              <h3 className="font-bold text-lg mb-2">Reuse & Donation</h3>
              <p className="text-gray-600 text-sm">Good-condition items</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
              ...
              <p className="text-gray-600 text-sm">Sorting all waste</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
                <Star className="w-8 h-8 text-yellow-600" />
              </div>
              <h3 className="font-bold text-lg mb-2">Auction Assets</h3>
              <p className="text-gray-600 text-sm">Valuable items on your behalf</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
              ...
              <p className="text-gray-600 text-sm">Legal waste transfer</p>
            </div>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Why Choose Lanora House in Newquay?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We understand every clearance is unique — and we treat every job with care, no matter how sensitive or complex.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Who We Work With in Newquay
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We're here to make a difficult job easier — with no judgment, no hassle, and no hidden fees.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Get a Free House Clearance Quote in Newquay
            </h2>
            <p className="text-xl mb-8 opacity-90">
              Let's get your space back to its best. Contact us for a fast, no-obligation quote.
            </p>
            ...
            <div className="mt-12 p-6 bg-white/10 rounded-lg backdrop-blur-sm">
              <h3 className="text-2xl font-bold mb-4">The Easy Way to Clear Space in Newquay</h3>
              <p className="text-lg opacity-90">
                Clear your clutter, the ethical way — with Lanora House.
              </p>
            </div>
          </motion.div>
        </div>
...
export default NewquayClearancePage;