        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              We're local, fully licensed, and committed to providing Cornwall with zero-to-landfill clearance solutions. <a href="tel:+447456809049" className="text-primary hover:underline">Call today</a> for immediate service.
            </p>
