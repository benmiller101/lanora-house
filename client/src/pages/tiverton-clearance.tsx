...
const TivertonClearancePage = () => {
  ...
  const handleQuoteSubmit = (e: React.FormEvent) => {
    ...
    // Add service type
    formData.append('serviceType', 'tiverton-clearance');
    formData.append('location', 'Tiverton');
  ...
  const services = [
    {
      ...
      title: "Complete or Partial House Clearances",
      description: "Full or selective residential clearances",
    ...
    },
    {
      ...
      title: "Lofts, Sheds, Garages & Outbuildings",
    ...
    },
    {
      ...
      title: "Garden Waste & Outdoor Rubbish",
    ...
    },
    {
      ...
      title: "Retail & Commercial Clearances",
  ...
  const whyChooseUs = [
    {
      ...
      title: "Local to Mid Devon",
      description: "Covering rural and town properties"
    },
    {
    ...
    },
    {
      ...
      description: "Just our professional, trained team"
    },
    {
      icon: <Users className="w-6 h-6 text-red-600" />,
      title: "Friendly, Discreet & Judgment-Free",
      description: "Service"
    },
    {
    ...
    },
    {
      ...
      description: "Often available at short notice"
    }
  ];
  ...
  const clientTypes = [
    {
      ...
      title: "Homeowners & Private Tenants",
    ...
    },
    {
      ...
      title: "Businesses & Office Managers",
      description: "Commercial clearances"
    },
    {
      icon: <Shield className="w-6 h-6 text-indigo-600" />,
      title: "Local Authorities & Housing Support Workers",
      description: "Support services"
    }
  ];

  const nearbyAreas = [
    "Cullompton", "Sampford Peverell", "Halberton", "Crediton", "Bampton", "Mid Devon"
  ];

  const faqs = [
    {
      question: "Do you offer probate clearances in Tiverton?",
      answer: "Yes – we provide full estate clearance services, including documentation and itemised reports upon request."
    },
    {
      question: "What happens to my furniture and belongings?",
      answer: "Items are reused, recycled, or donated whenever possible. Valuable items may be sold to offset your clearance costs."
    },
    {
      question: "Can you clear hoarded properties?",
      answer: "Absolutely – we're experienced, non-judgmental, and discreet."
    },
    {
      question: "Do you provide urgent clearances?",
      answer: "Yes – same or next-day service is often available depending on your location and the job size."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-blue-50">
      <Helmet>
        <title>House Clearance Tiverton Mid Devon - Professional Property Clearance | Lanora House</title>
        <meta name="description" content="Professional property clearance in Tiverton and Mid Devon – cleared with care, recycled with purpose. Fast, respectful, environmentally responsible clearance." />
        <meta name="keywords" content="house clearance Tiverton, property clearance Tiverton Devon, probate clearance Tiverton, office clearance Tiverton, waste removal Tiverton" />
        <meta property="og:title" content="House Clearance Tiverton Mid Devon | Lanora House" />
        <meta property="og:description" content="Professional clearance services in Tiverton. Local team with eco-friendly waste strategy and flexible appointments." />
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-primary bg-clip-text text-transparent">
              ...
              <span className="text-3xl md:text-5xl flex items-center justify-center gap-3 flex-wrap">
                House Clearance
                <span className="text-2xl md:text-3xl text-gray-600 font-normal">Tiverton</span>
              </span>
            </h1>
            <p className="text-xl text-gray-600 mb-4 max-w-3xl mx-auto">
              Whether you're clearing a home after bereavement, prepping a rental property, moving out, or handling a cluttered space — Lanora House offers respectful and reliable house clearance in Tiverton and surrounding areas.
            </p>
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              We're fully licensed, environmentally responsible, and here to make clearing your property simple, fast, and stress-free. <a href="tel:+447843930927" className="text-primary hover:underline">Call us now</a> to get started.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Dialog open={isQuoteDialogOpen} onOpenChange={setIsQuoteDialogOpen}>
                ...
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                  <DialogHeader>
                    <DialogTitle className="text-2xl text-primary">Get Your Free Tiverton Clearance Quote</DialogTitle>
                  </DialogHeader>
                  <form onSubmit={handleQuoteSubmit} className="space-y-6">
                      ...
                      <div>
                        ...
                        <Select value={quoteForm.propertyType} onValueChange={(value) => handleInputChange("propertyType", value)}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="town-property">Town Property</SelectItem>
                    ...
                    <div>
                      <Label htmlFor="address">Property Address in Tiverton *</Label>
                      <Input
                        id="address"
                        required
                        value={quoteForm.address}
                        onChange={(e) => handleInputChange("address", e.target.value)}
                        placeholder="Enter full address in Tiverton area"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Select value={quoteForm.clearanceType} onValueChange={(value) => handleInputChange("clearanceType", value)}>
                          ...
                          <SelectContent>
                            <SelectItem value="complete-partial-house">Complete or Partial House Clearances</SelectItem>
                            <SelectItem value="furniture-white-goods">Furniture, White Goods, Mattresses & Bulky Items</SelectItem>
                            <SelectItem value="loft-shed-garage-outbuilding">Lofts, Sheds, Garages & Outbuildings</SelectItem>
                            <SelectItem value="garden-outdoor">Garden Waste & Outdoor Rubbish</SelectItem>
                            ...
                            <SelectItem value="commercial-retail">Retail & Commercial Clearances</SelectItem>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Any parking restrictions, narrow rural roads, stairs, or other access issues in Tiverton we should know about?"
                        rows={3}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Tell us more about your clearance requirements in Tiverton"
                        rows={4}
                      />
                    </div>
      ...
      {/* Tiverton Location Showcase Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <Badge className="mb-4 bg-primary/20 text-primary border-primary/30">
                <Castle className="w-4 h-4 mr-1" />
                Proudly Serving Tiverton
              </Badge>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">
                Mid Devon's
                <br />
                <span className="text-2xl md:text-3xl text-gray-700">Historic Castle Town</span>
              </h2>
              <div className="space-y-4 text-gray-600">
                <p className="text-lg leading-relaxed">
                  <strong className="text-primary">South West specialists</strong> serving Tiverton and Mid Devon. We understand this historic castle town and its unique clearance needs.
                </p>
                <p className="leading-relaxed">
                  From the town center to rural properties, no matter the size or condition of the property, we provide trusted clearance services throughout Tiverton and the surrounding area.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                  ...
                  <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Wherever possible</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="bg-blue-50 rounded-2xl p-6 shadow-lg">
                <div className="text-center mb-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Find Us in Tiverton</h3>
                  <p className="text-gray-600">Historic Castle Town, Mid Devon</p>
                </div>
                
                {/* Embedded Google Maps */}
                <div className="relative rounded-xl overflow-hidden shadow-md bg-gray-200 h-80">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d20374.955049556546!2d-3.4885!3d50.9022!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x486c4d4d4d4d4d4d%3A0x4b9b8b4b0c5d0e!2sTiverton%2C%20UK!5e0!3m2!1sen!2suk!4v1620000000000!5m2!1sen!2suk"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
                ...
                <div className="mt-6 p-4 bg-white rounded-xl shadow-sm border">
                  ...
                  <div className="text-sm text-gray-600 space-y-2">
                    <div>🏰 <strong>Historic Castle:</strong> Tiverton Castle built in 1106, still visitable today</div>
                    <div>🕳️ <strong>Secret Passages:</strong> Complete with secret passages and Civil War history</div>
                    <div>🔫 <strong>Battle Scars:</strong> Civil War bullet holes still visible in the walls</div>
                    <div>🏡 <strong>Living History:</strong> Parts of the castle are now a private home</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-blue-100 text-blue-800 border-blue-300">
              ...
              What We Clear in Tiverton
            </Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Complete Clearance Services
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              No matter the size or condition of the property – we clear it all, and we do it right.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-green-50">
        <div className="max-w-4xl mx-auto text-center">
          <Badge className="mb-4 bg-green-100 text-green-800 border-green-300">
            ...
            Eco-Friendly House Clearance in Tiverton
          </Badge>
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">
            We Don't Just Clear Properties — We Protect the Planet
          </h2>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            We aim for zero-to-landfill wherever possible — because clearance shouldn't cost the Earth.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-bold text-lg mb-2">Recycling & Responsible Waste Sorting</h3>
              <p className="text-gray-600 text-sm">Environmental focus</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">On your behalf (optional)</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Why Choose Lanora House in Tiverton?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We make your clearance easy, efficient, and environmentally sound.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Who We Help in Tiverton
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Whatever your situation, you'll receive the same respectful, dependable service.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Book House Clearance in Tiverton Today
            </h2>
            <p className="text-xl mb-8 opacity-90">
              Let's get your space back — safely and responsibly. Contact us now for a free, no-obligation quote.
            </p>
            ...
            <div className="mt-12 p-6 bg-white/10 rounded-lg backdrop-blur-sm">
              <h3 className="text-2xl font-bold mb-4">Tiverton's Go-To Clearance Team – Lanora House</h3>
              <p className="text-lg opacity-90">
                Compassionate, eco-conscious property clearance, handled by people who care.
              </p>
            </div>
          </motion.div>
        </div>
...
export default TivertonClearancePage;