...
const TorquayClearancePage = () => {
  ...
  const handleQuoteSubmit = (e: React.FormEvent) => {
    ...
    // Add service type
    formData.append('serviceType', 'torquay-clearance');
    formData.append('location', 'Torquay');
  ...
  const services = [
    ...
    },
    {
      ...
      title: "Hoarded Homes",
      description: "Respectful, discreet service",
      highlight: "Expert help"
    },
    {
      icon: <Building className="w-8 h-8 text-indigo-600" />,
      title: "Retail, Office & Commercial Property Clearance",
  ...
  const whyChooseUs = [
    ...
    },
    {
      ...
      description: "Just our own professional staff"
    },
    {
    ...
    },
    {
      ...
      description: "To suit your schedule"
    }
  ];
  ...
  const clientTypes = [
    ...
    },
    {
      ...
      title: "Families Managing Probate Clearances",
    ...
    },
    {
      ...
      title: "Offices, Shops & Commercial Spaces",
      description: "Commercial clearances"
    },
    {
      icon: <Shield className="w-6 h-6 text-indigo-600" />,
      title: "Housing Associations & Care Services",
      description: "Support agencies"
    }
  ];

  const nearbyAreas = [
    "Paignton", "Brixham", "Newton Abbot", "Teignmouth", "Totnes", "South Devon"
  ];

  const faqs = [
    {
      question: "Can you clear a probate property in Torquay?",
      answer: "Yes – we regularly work with solicitors, estate managers, and families during sensitive times."
    },
    {
      question: "Do you offer same-day or urgent clearances?",
      answer: "We often can. Contact us early to check availability."
    },
    {
      question: "Can you remove fridges, cookers, and large items?",
      answer: "Of course – we handle heavy, bulky, and awkward waste without issue."
    },
    {
      question: "Do you help with hoarded or difficult properties?",
      answer: "Absolutely – we offer a discreet, non-judgmental service and can clear even the most challenging spaces."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-blue-50">
      <Helmet>
        <title>House Clearance Torquay English Riviera - Professional Property Clearance | Lanora House</title>
        <meta name="description" content="Lanora House delivers expert house and property clearance in Torquay and the English Riviera with zero-to-landfill service. Trusted, affordable clearance services across South Devon." />
        <meta name="keywords" content="house clearance Torquay, property clearance Torquay Devon, probate clearance Torquay, office clearance Torquay, waste removal Torquay" />
        <meta property="og:title" content="House Clearance Torquay English Riviera | Lanora House" />
        <meta property="og:description" content="Lanora House provides professional clearance services in Torquay. Devon-based team with eco-conscious approach and flexible booking times." />
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-primary bg-clip-text text-transparent">
              ...
              <span className="text-3xl md:text-5xl flex items-center justify-center gap-3 flex-wrap">
                House Clearance
                <span className="text-2xl md:text-3xl text-gray-600 font-normal">Torquay</span>
              </span>
            </h1>
            <p className="text-xl text-gray-600 mb-4 max-w-3xl mx-auto">
              Need help clearing a property in Torquay? Whether it's a full home, a flat, a garden shed, or a commercial space — Lanora House offers trusted, affordable house clearance services in Torquay and across South Devon.
            </p>
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              We handle everything from probate and hoarded homes to simple furniture removals — all done with care, efficiency, and an eco-conscious approach.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Dialog open={isQuoteDialogOpen} onOpenChange={setIsQuoteDialogOpen}>
                ...
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                  <DialogHeader>
                    <DialogTitle className="text-2xl text-primary">Get Your Free Torquay Clearance Quote</DialogTitle>
                  </DialogHeader>
                  <form onSubmit={handleQuoteSubmit} className="space-y-6">
                      ...
                      <div>
                        ...
                        <Select value={quoteForm.propertyType} onValueChange={(value) => handleInputChange("propertyType", value)}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="riviera-property">English Riviera Property</SelectItem>
                    ...
                    <div>
                      <Label htmlFor="address">Property Address in Torquay *</Label>
                      <Input
                        id="address"
                        required
                        value={quoteForm.address}
                        onChange={(e) => handleInputChange("address", e.target.value)}
                        placeholder="Enter full address in Torquay area"
                      />
                    </div>
                      ...
                      <div>
                        ...
                        <Select value={quoteForm.clearanceType} onValueChange={(value) => handleInputChange("clearanceType", value)}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="loft-garage-shed-basement">Lofts, Garages, Sheds & Basements</SelectItem>
                            <SelectItem value="furniture-white-goods">Furniture, Mattresses, Sofas & White Goods</SelectItem>
                            <SelectItem value="garden-shed">Garden Waste & Shed Dismantling</SelectItem>
                            <SelectItem value="probate-estate">Probate & Deceased Estate Clearances</SelectItem>
                            <SelectItem value="hoarded-homes">Hoarded Homes</SelectItem>
                            <SelectItem value="commercial-office">Retail, Office & Commercial Property Clearance</SelectItem>
                            <SelectItem value="electronic-waste">Electronic Waste (WEEE)</SelectItem>
                            <SelectItem value="hazardous-bio">Hazardous Waste & Biohazards</SelectItem>
                            <SelectItem value="wait-load">Wait & Load Removals</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      <div>
                        ...
                        <Select value={quoteForm.timeframe} onValueChange={(value) => handleInputChange("timeframe", value)}>
                          ...
                          <SelectContent>
                            <SelectItem value="same-day-urgent">Same Day / Urgent</SelectItem>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Any parking restrictions, narrow coastal roads, stairs, or other access issues in Torquay we should know about?"
                        rows={3}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Tell us more about your clearance requirements in Torquay"
                        rows={4}
                      />
                    </div>
      ...
      {/* Torquay Location Showcase Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <Badge className="mb-4 bg-primary/20 text-primary border-primary/30">
                <BookOpen className="w-4 h-4 mr-1" />
                Proudly Serving Torquay
              </Badge>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">
                The English Riviera's
                <br />
                <span className="text-2xl md:text-3xl text-gray-700">Literary Heritage Town</span>
              </h2>
              <div className="space-y-4 text-gray-600">
                <p className="text-lg leading-relaxed">
                  <strong className="text-primary">South West specialists</strong> serving Torquay and the English Riviera. We understand this historic literary town and its unique clearance needs.
                </p>
                <p className="leading-relaxed">
                  From the town center to the coastal properties, from one-bedroom flats to large estates, we provide trusted clearance services throughout Torquay and the surrounding area.
                </p>
            ...
            <div className="relative">
              <div className="bg-blue-50 rounded-2xl p-6 shadow-lg">
                <div className="text-center mb-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Find Us in Torquay</h3>
                  <p className="text-gray-600">English Riviera, South Devon</p>
                </div>
                
                {/* Embedded Google Maps */}
                <div className="relative rounded-xl overflow-hidden shadow-md bg-gray-200 h-80">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d20374.955049556546!2d-3.5315!3d50.4619!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x486c3f8b5a8d5a5a%3A0x4b9b8b4b0c5d0e!2sTorquay%2C%20UK!5e0!3m2!1sen!2suk!4v1620000000000!5m2!1sen!2suk"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
                ...
                <div className="mt-6 p-4 bg-white rounded-xl shadow-sm border">
                  ...
                  <div className="text-sm text-gray-600 space-y-2">
                    <div>📚 <strong>Agatha Christie's Birthplace:</strong> World's best-selling novelist was born here</div>
                    <div>🔍 <strong>Christie Mile:</strong> Famous Agatha Christie Mile celebrates her legacy</div>
                    <div>🏖️ <strong>English Riviera:</strong> Part of the beautiful English Riviera UNESCO Global Geopark</div>
                    <div>🌊 <strong>Coastal Beauty:</strong> Stunning Victorian seaside resort town</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-blue-100 text-blue-800 border-blue-300">
              ...
              What We Clear in Torquay
            </Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Complete Clearance Services
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We make clearing your space easy, fast, and stress-free.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-green-50">
        <div className="max-w-4xl mx-auto text-center">
          <Badge className="mb-4 bg-green-100 text-green-800 border-green-300">
            ...
            Ethical Waste Disposal in Torquay
          </Badge>
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">
            We're Not Just About Removals
          </h2>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            We reduce environmental impact — and often reduce your costs too.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-lg mb-2">Appraising & Selling</h3>
              <p className="text-gray-600 text-sm">Items of value</p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-white rounded-lg shadow-md mb-4 mx-auto w-fit">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">For waste handling</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">
              Why Torquay Residents Choose Lanora House
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              At Lanora House, from one-bedroom flats to large estates, we clear it all — carefully and completely.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We tailor every clearance to your needs — and always put respect and discretion first.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Book a House Clearance in Torquay Today
            </h2>
            <p className="text-xl mb-8 opacity-90">
              Ready to reclaim your space? Get your free quote from Lanora House now.
            </p>
            ...
            <div className="mt-12 p-6 bg-white/10 rounded-lg backdrop-blur-sm">
              <h3 className="text-2xl font-bold mb-4">House Clearance Torquay – Done Right with Lanora House</h3>
              <p className="text-lg opacity-90">
                Fast, friendly, and fully licensed property clearance throughout South Devon.
              </p>
            </div>
          </motion.div>
        </div>
...
export default TorquayClearancePage;